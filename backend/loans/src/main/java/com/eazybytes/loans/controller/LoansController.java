...
public class LoansController {
    ...
    @Autowired
    private LoansApplicationInfoDto loansApplicationInfoDto;
    ...
    public ResponseEntity<LoansApplicationInfoDto> getContactInfo(){
        return ResponseEntity.status(HttpStatus.OK).body(loansApplicationInfoDto);
    }
