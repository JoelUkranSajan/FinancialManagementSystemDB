...
public class CardsController {
    ...
    @Autowired
    private CardsApplicationInfoDto cardsApplicationInfoDto;
    ...
    public ResponseEntity<CardsApplicationInfoDto> getContactInfo(){
        return ResponseEntity.status(HttpStatus.OK).body(cardsApplicationInfoDto);
    }
